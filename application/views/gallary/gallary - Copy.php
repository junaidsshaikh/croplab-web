...
<section class="ls ms page_portfolio section_padding_top_130 columns_padding_0 columns_margin_0 container_padding_0">
...
<section class="ls ms section_padding_top_50 section_padding_bottom_130">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center"><a href="#" class="theme_button color1 min_width_button margin_0">Load More</a></div>
        </div>
    </div>
</section>
